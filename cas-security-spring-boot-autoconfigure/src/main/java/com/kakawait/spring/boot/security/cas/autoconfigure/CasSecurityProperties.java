...
public class CasSecurityProperties {
    ...
    public static class Server {
        ...
        /**
         * CAS Server base url.
         * Example https://my-cas.server.com/
         */
        private URI baseUrl;

        /**
         * CAS Server validation base url.
         * Example https://my-cas.server.internal/
         * <p>
    ...
    public static class Service {
        ...
        /**
         * CAS Service callback base url.
         * Example https://my.service.com/
         * <p>
         * If defined it will be used to compute complete <i>proxy callback url</i> instead of using
         * {@link Service#baseUrl}.
         * It will also be used even if {@link #baseUrl} it is not defined and {@link Service#resolutionMode}
         * is set to {@link ServiceResolutionMode#DYNAMIC}.
         * <p>
